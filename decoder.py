...
class Decoder:
    ...
    def __init__(self, data, register_length, traceback_depth):
        self.active_states = []
    ...
    def decode(self):
        ...
        # first 3 bits - starting in state 0
        current_data = self.data[0:3]
        self._decode_single_state(0, "0", current_data)
        self._decode_single_state(0, "1", current_data)
...
if __name__ == '__main__':
    data = read_bits("test/encoded.txt")
    REGISTER_LENGTH = 8
    decoder = Decoder(data, REGISTER_LENGTH, REGISTER_LENGTH)
